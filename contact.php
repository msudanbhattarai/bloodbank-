    ...
    <div class="bgimg">
        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
         ...
         <div class="container pt-3">
            ...
            <form action="">
              <div class="form-group">
                <label for="email"><h2>Full Name:</h2></label>
              <input type="text" class="form-control" placeholder="Full name" id="mail" name="fname">
              </div>
              <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                      ...
                      <div class ="form-group">
                          <label for ="phoneno"><h2>Phone Number:</h2></label>
                          <input type="number" class="form-control" id="" placeholder="Phone number" name="phone">

                      </div>
                      <div class="form-group">
                        <label for="comment"><h2>Message:</h2></label>
                        <textarea class="form-control" rows="5" id="comment" name="text"></textarea>
                      </div>
                      <button type="button" class="btn btn-outline-danger" value="submit" >submit </button>
